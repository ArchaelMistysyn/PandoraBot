...
quests_data = {
    ...
    10: [3, "A False Deity", "Pandora, The Celestial",
         ...
         [('EssenceXVI', 3), ('Chest', 10)], 'Echelon 2'],
    ...
    35: [3, "A Promise Broken", "Pandora, The Celestial",
         ...
         [('EssenceII', 3), ('Chest', 10)], 'Echelon 7'],
    ...
    40: [3, "All Or Nothing", "Pandora, The Celestial",
         ...
         [('EssenceIV', 3), ('Chest', 10)], 'Echelon 8'],
    ...
    45: [3, "Ending A Wish", "Eleuia, The Wish",
         ...
         [('Gemstone10', 1), ('Chest', 10)], 'Echelon 9'],
    46: [1, "Through The Ether", "Pandora, The Celestial",
         ...
         [('Crystal4', 1), ('Chest', 5)], None],
    47: [3, "A Flower Foregone", "Fleur, The Oracle",
         ...
         1, 21, None,
         "Defeat XXVIII - Fleur, The Oracle",
         [('Summon3', 5), ('Chest', 5)], None],
    48: [3, "A God's Judgement", "Yubelle, The Adjudicator",
         ...
         1, 22, None,
         "Defeat XXIX - Yubelle, The Adjudicator",
         [('EssenceXXIX', 1), ('Chest', 5)], None],
    ...
    50: [3, "Root Of Reality", "Echo of Thana, the Death",
         ...
         [('EssenceXXX', 1), ('Chest', 50)], 'Echelon 10 (MAX)'],
    ...
    54: [2, "A Moment Forever", "Pandora, The Celestial",
         ...
         [("Sacred", 1), ('Trove8', 5), ('Chest', 99)], None],
