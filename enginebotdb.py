...
enginebot_database = start_engine()


def run_query(raw_query, return_value=False, batch=False, params=None):
    return enginebot_database.run_session_query(raw_query, return_value=return_value, batch=batch, params=params)


async def close_engine_database_session():
    enginebot_database.close_session()
