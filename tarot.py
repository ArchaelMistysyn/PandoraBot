...
card_stat_dict = {
                  ...
                  "XXVII": [0, ["X% Chance to trigger Bloom on hit", 5, "specialty_rate", 0],
                          ["Critical Application", 1, "critical_application", None]],
                  "XXVIII": [6, ["X% Chance to trigger Bloom on hit", 5, "specialty_rate", 0],
                  ...
                  "XXX": ["All", ["X% Chance to trigger Bloom on hit", 5, "specialty_rate", 0],
