...
abyss2_img = f"{web_gallery_url}Displays/Banners/Abyss.webp"
...
availability_list_nongear = ["Gemstone", "Fish", "Fragment", "Crystal", "Heart", "Skull", "Misc", "Essence", "Trove",
                             "Ore", "Potion", "Lotus", "Flame", "Summon", "Stone", "Token", "Fae"]
