...
def get_item_tier_damage(material_tier: str) -> int:
    match material_tier:
        ...
        case "Mithril" | "Lustrous" | "Soulbound" | "Jeweled" | "Shining" | "Abyssal" | "Majestic":
            damage_temp = 1000
        case "Diamond" | "Radiant" | "Phantasmal" | "Calamitous":
            damage_temp = 2500
        case "Crystal" | "Divine" | "Spectral" | "Balefire":
            damage_temp = 5000
        case "Key of Freedom," | "Relic":
            damage_temp = 20000
        case "Key of Desires," | "Artifact":
            damage_temp = 40000
        case "Key of Hopes," | "Rainbow":
            damage_temp = 60000
        case "Key of Dreams," | "Chroma":
            damage_temp = 80000
        case "Key of Wishes," | "Prisma":
            damage_temp = 150000
        case "??? of Wishes":
            damage_temp = 250000
        case "Voidcrystal":
