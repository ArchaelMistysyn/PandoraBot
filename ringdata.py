ring_values_dict = {
    # Elemental Rings
    "Elemental Ring of Fire": [[("Fire Curse X%", "elemental_curse", 200, 0)], (0, None), [0]],
    "Elemental Ring of Water": [[("Water Curse X%", "elemental_curse", 200, 1)], (0, None), [1]],
    "Elemental Ring of Lightning": [[("Lightning Curse X%", "elemental_curse", 200, 2)], (0, None), [2]],
    "Elemental Ring of Earth": [[("Earth Curse X%", "elemental_curse", 200, 3)], (0, None), [3]],
    "Elemental Ring of Wind": [[("Wind Curse X%", "elemental_curse", 200, 4)], (0, None), [4]],
    "Elemental Ring of Ice": [[("Ice Curse X%", "elemental_curse", 200, 5)], (0, None), [5]],
    "Elemental Ring of Shadow": [[("Shadow Curse X%", "elemental_curse", 200, 6)], (0, None), [6]],
    "Elemental Ring of Light": [[("Light Curse X%", "elemental_curse", 200, 7)], (0, None), [7]],
    "Elemental Ring of Celestial": [[("Celestial Curse X%", "elemental_curse", 200, 8)], (0, None), [8]],
    # Primordial Signet
    ...
    "Boundary Ring of Horizon": [[("Earth Curse X%", "elemental_curse", 250, 3),
                                  ...
                                  ("[RESONANCE]", "resonance", 100, 11)], (10, 2), [3, 4]],
    "Hidden Ring of Eclipse": [[("Shadow Curse X%", "elemental_curse", 250, 6),
                                ("Light Curse X%", "elemental_curse", 250, 7),
                                ("[RESONANCE]", "resonance", 100, 12)], (10, 3), [6, 7]],
    "Cosmic Ring of Stars": [[("Celestial Curse X%", "elemental_curse", 1000, 8),
                              ("[RESONANCE]", "resonance", 100, 2)], (10, 4), [8]],
    "Orbital Ring of Solar Flux": [[("Fire Curse X%", "elemental_curse", 200, 0),
                                    ("Wind Curse X%", "elemental_curse", 200, 4),
                                    ("Light Curse X%", "elemental_curse", 200, 7),
                                    ("[RESONANCE]", "resonance", 100, 19)], (10, 5), [6, 7]],
    "Orbital Ring of Lunar Tides": [[("Water Curse X%", "elemental_curse", 200, 1),
                                     ("Ice Curse X%", "elemental_curse", 200, 5),
                                     ("Shadow Curse X%", "elemental_curse", 200, 6),
                                     ("[RESONANCE]", "resonance", 100, 18)], (10, 6), [6, 7]],
    "Orbital Ring of Terrestria": [[("Singularity Curse X%", "singularity_curse", 750, None),
                                    ("[RESONANCE]", "resonance", 100, 21)], (10, 7), [8]],
    "Rainbow Ring of Confluence": [[("Omni Curse X%", "all_elemental_curse", 200, None),
                                    ("[RESONANCE]", "resonance", 100, 6)], (10, 8), ["all"]],
    # Legendary Rings
